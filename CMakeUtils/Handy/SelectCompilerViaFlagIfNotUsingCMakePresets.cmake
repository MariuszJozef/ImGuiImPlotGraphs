...
cmake -S . -B <buildDir> -G <generator> -D CMAKE_BUILD_TYPE=Debug -D CMAKE_C_COMPILER=<C compiler> -D CMAKE_CXX_COMPILER=<C++ compiler> --fresh

cmake -S . -B <buildDir> -G <generator> -D CMAKE_BUILD_TYPE=Release -D CMAKE_C_COMPILER=<C compiler> -D CMAKE_CXX_COMPILER=<C++ compiler> --fresh

#3.
Assuming that 'gnu', 'clang', 'msvc' are executables on your path, then:
...
cmake -S . -B <buildDir> -G <generator> -D CMAKE_BUILD_TYPE=Debug           -D setCompiler=gnu --fresh
cmake -S . -B <buildDir> -G <generator> -D CMAKE_BUILD_TYPE=RelWithDebInfo  -D setCompiler=clang --fresh
cmake -S . -B <buildDir> -G <generator> -D CMAKE_BUILD_TYPE=MinSizeRel      -D setCompiler=msvc --fresh
]]
